...
# Parsing + Configuration Script – DV_PK_0002 - Rev. A

This **Parsing + Configuration** script is designed for the **DV_PK_0002** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – DV_PK_0002 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **DV_PK_0002** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
